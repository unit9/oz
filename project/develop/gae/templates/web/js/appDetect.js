...
(function() {
  ...
  $(function() {
    ...
    window.showTechOrTrailer = function(label) {
      if (label.indexOf('Chrome_NoWebGL_button') > -1) {
        return false;
      }
      if (label.indexOf('FF4_noWebGL_button') > -1) {
        return false;
      }
      if (label.indexOf('NoWebGLRenderingContext_button') > -1) {
        return false;
      }
      if (label.indexOf('NoWebGL_button') > -1) {
        return false;
      }
      return true;
    };
