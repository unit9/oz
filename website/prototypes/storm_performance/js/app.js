...
(function() {
  ...
  App = (function() {
    ...
    App.prototype.onTerrainLoaded = function(iflscene) {
      var geom, mat, mesh, pl, shader, vertex, _i, _len, _ref;
      ...
      $("#loading").remove();
      this.createParticleSystem(iflscene);
      return;
      ...
      this.particle.rotation.x = Math.PI;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        pl.updateMatrix();
        this.particle.add(pl);
      }
      this.scene.add(this.particle);
      return null;
    };

    App.prototype.createParticleSystem = function(iflscene) {
      var mat, mesh, shader;
      mesh = iflscene.children[0].children[0];
      ...
      mat.envMap = this.skyCubeTexture;
      mat.transparent = true;
      mat.lights = false;
      ...
      this.particle = new THREE.ParticleSystem(mesh.geometry, mat);
      this.particle.position.y = -5;
      this.particle.rotation.x = Math.PI;
    ...
    App.prototype.render = function() {
      var delta, exc, inv, mat, max, min, pl, pos, ran, _i, _len, _ref, _ref1;
      delta = this.clock.getDelta();
      this.renderer.clear();
      if (this.particle != null) {
        mat = new THREE.Matrix4();
        this.particle.rotation.y -= .01;
        this.particle.updateMatrix();
        inv = mat.getInverse(this.particle.matrix);
        _ref = this.particle.children;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          pl = _ref[_i];
